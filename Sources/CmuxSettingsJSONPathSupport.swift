...
extension CmuxSettingsFileStore {
    ...
    static let supportedSettingsJSONPaths: Set<String> = [
        ...
        "automation.pilotMode.runMode",
        "automation.pilotMode.instructions",
        "automation.pilotMode.answerPermissionRequests",
        "automation.pilotMode.answerQuestions",
        "automation.pilotMode.autoAllowReadOnly",
        "automation.pilotMode.denyPatterns",
        "automation.pilotMode.maxConsecutiveDecisions",
        "automation.pilotMode.judgeTimeoutSeconds",
        "automation.portBase",
