        ...
        return [
            ...
            [
                "automation": [
                    ...
                    "pilotMode": [
                        "enabled": AutomationCatalogSection().pilotMode.defaultValue,
                        "runMode": AutomationCatalogSection().pilotModeRunMode.defaultValue,
                        "instructions": AutomationCatalogSection().pilotModeInstructions.defaultValue,
                        "answerPermissionRequests": AutomationCatalogSection().pilotModeAnswersPermissionRequests.defaultValue,
                        "answerQuestions": AutomationCatalogSection().pilotModeAnswersQuestions.defaultValue,
                        "autoAllowReadOnly": AutomationCatalogSection().pilotModeAutoAllowReadOnly.defaultValue,
                        "denyPatterns": [String](),
                        "maxConsecutiveDecisions": AutomationCatalogSection().pilotModeMaxConsecutiveDecisions.defaultValue,
                        "judgeTimeoutSeconds": Int(AutomationCatalogSection().pilotModeJudgeTimeout.defaultValue),
                    ],
