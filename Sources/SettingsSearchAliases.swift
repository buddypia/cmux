...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "automation:pilot-mode": localized("settings.search.alias.setting.automation.pilot-mode", defaultValue: "automation.pilotMode pilot mode autopilot auto approve auto-approve autoapprove automatic approval approve for me answer permission requests questions unattended away afk delegate agent decisions shadow active dry run guardrails instructions deny patterns"),
