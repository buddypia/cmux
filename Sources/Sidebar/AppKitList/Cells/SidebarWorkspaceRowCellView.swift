...
final class SidebarWorkspaceRowTableCellView: NSTableCellView {
    ...
    private func configureAgentStatusPills(
        ...
        Self.pool(&agentStatusPills, count: groups.count, parent: contentContainer) { SidebarRowAgentStatusPill() }
    ...
    private func configurePullRequestsAndPorts(model: SidebarWorkspaceRowModel, palette: SidebarRowPalette) {
        ...
        Self.pool(&portButtons, count: chipCount, parent: contentContainer) { SidebarRowLinkButton() }
