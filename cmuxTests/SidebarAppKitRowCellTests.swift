...
struct SidebarAppKitRowCellTests {
    ...
    private static func makeModel(
        ...
        return SidebarWorkspaceRowModel(
            ...
            index: 0,
            snapshot: snapshot ?? makeSnapshot(metadataEntries: metadataEntries),
    ...
    func agentStatusPillsNeverPaintPastTheRowTrailingEdge(_ width: CGFloat) {
        ...
        let pills = Self.descendants(of: cell).compactMap { $0 as? SidebarRowAgentStatusPill }.filter { !$0.isHidden }
